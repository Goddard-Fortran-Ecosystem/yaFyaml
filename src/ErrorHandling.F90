...
module fy_ErrorHandling
  ...
  public :: set_throw_method
   ...
   interface assert
      module procedure assert_condition
 ...
 contains
   ...
   logical function assert_condition(message, condition, filename, line, rc) result(fail)
    ...
    end function assert_condition


   logical function assert_status(message, status, filename, line, rc) result(fail)
      character(*), intent(in) :: message
